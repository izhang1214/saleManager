    ...
    <div class="sale-Order">
        <div class="quoto-search">
            <el-form :inline="true" class="demo-form-inline">
                <el-form-item label="销售：" v-if="roleId==0">
                    <el-input placeholder="请输入" v-model="searchParams.custName"></el-input>
                </el-form-item>
        ...
        <div class="quoto-showData">
            ...
            <div class="quoto-footer">
                <el-button>
                    <a :href="'/down/dowSaleExcel?roleId='+roleId+'&str='+userId" download='模板.xlsx'>导出报表</a>
                </el-button>
                <el-pagination
    ...
    export default {
        ...
        methods: {
            ...
            addSale(){
                ...
                console.log(this.$refs.addSaleRef);
            },
